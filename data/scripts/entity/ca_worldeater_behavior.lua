...
function createTargetLaserGlow(...)
    if CAWorldEater.createTargetLaserGlow then return CAWorldEater.createTargetLaserGlow(...) end
end
...
function onDamaged(...)
    if CAWorldEater.onDamaged then return CAWorldEater.onDamaged(...) end
end
